...
```bash
sudo apt update && sudo apt install -y git && rm -rf ~/.local/share/ZK_Draw && git clone https://github.com/likemoue/ZK_Draw.git ~/.local/share/ZK_Draw && cd ~/.local/share/ZK_Draw && chmod +x install.sh run.sh && ./install.sh
```
